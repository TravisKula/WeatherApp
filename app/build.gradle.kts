...
dependencies {
    ...
    implementation ("com.squareup.retrofit2:retrofit:2.11.0")  //add retrofit dependency
    implementation ("com.squareup.retrofit2:converter-gson:2.11.0")  //add retrofit json converter
